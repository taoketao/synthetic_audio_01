//-----------------------------------------------------------------------------
// Name: Log.cpp
// This program is meant to take the logarithm of every sample of a sound file,
// with the purpose of smoothing it.
//-----------------------------------------------------------------------------
#include "RtAudio.h"
#include <math.h>
#include <iostream>
...
int main( int argc, char ** argv )
{
    ...
    if (argc == 2) {
        ...
        cout << "Must have one extra argument, the file name." << endl;
        exit(1);
    }
